...
?>
	...
	<section id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
          ...
          <div class="col-lg-6 input-group home">

            <a class="btn btn-primary" role="button" href="http://hours.tillydrone.network/add/">Add Hours</a><a class="btn btn-primary" role="button" href="http://hours.tillydrone.network/view-user/">View Hours</a>
