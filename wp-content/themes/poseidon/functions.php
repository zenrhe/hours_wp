...
function add_Hours()
{
    if (! empty($_POST)) {
        ...
        //echo "userID: ".$_POST['userID']." Hours: ".$_POST['hours']." Desc: ".$_POST['description']." Venue: ".$_POST['venue']." Date:".$_POST['date'];
        ...
        $wpdb->query(
            $wpdb->prepare(
        "
         INSERT INTO wphrs_hrslog
         ( UserID, Hours, Description, Venue, dateWorked)
         VALUES ( %d, %d, %s, %d, %s )
        ",
         array(
            $userID,
        ...
        //Values - $d = int, $ = string (even when date)

        //After Adding, take user to view their hours
        wp_redirect('view-user');
    }
}
add_action('admin_post_nopriv_add_Hours_Form', 'add_Hours');
add_action('admin_post_add_Hours_Form', 'add_Hours');

function approve_Hours()
{
    //echo "userID: ".$_POST['userID']."/ Row: ".$_POST['rowID'];
...
add_action('admin_post_nopriv_approve_Hours_Form', 'approve_Hours');
add_action('admin_post_approve_Hours_Form', 'approve_Hours');
